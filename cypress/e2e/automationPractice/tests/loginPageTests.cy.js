...
describe('Login page tests', () => {
    it('Verifying user login', () => {
        ...
        cy.isElementHasCorrectSignature(loggedInPage.userNameInfoLnk(), "Brad Pitt");
    ...
    it('Verifying alert message for the login field', () => {
        ...
        cy.isElementHasCorrectSignature(loginPage.errorMsg(), newTestData.loginFldErrorMessage);
    });

    it('Verifying alert message for the password field', () => {
        loginPage.act_login(URERNAME, " ");
        cy.isElementHasCorrectSignature(loginPage.errorMsg(), newTestData.passwordFldErrorMessage);
    });
    ...
    it('Verify alert messages using data-driven testing', () => {
        cy.fixture("loginData.json").then((data) => {
            data.forEach((userData) => {
                ...
                cy.isElementHasCorrectSignature(loginPage.errorMsg(), userData.targetErrorMessage);
